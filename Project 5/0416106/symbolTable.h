...
int InsertLoopTableEntry (SymbolTable*, TableEntry*);
...
int GetActualDimension(const Type*);
...
TableEntry* FindEntryInRange(SymbolTable*,char*);
...
void CheckFileName(char*,char*);
void CheckReturnStatement(Type*,Expr*);
int CheckConstAssign(Expr*);
int CheckAssignmentType(Expr*,Expr*);
int AssignmentCheck(Expr*,Expr*);
int SimpleScalarCheck(Expr*);
int CheckParameterNumber(Expr*);
void CheckCondExpression(Expr*);
void CheckArrayIndex(Expr*);
int CheckFunctionAttribute (TypeList*);
